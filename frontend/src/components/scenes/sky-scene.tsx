...
export function Hills({ className }: { className?: string }) {
	return (
		<div className={cn("", className)}>
			<svg
				className="absolute lg:-bottom-18 2xl:-bottom-36 xl:-bottom-24 md:-bottom-12 -bottom-2 left-0 w-full bg-background-secondary"
			...
			<svg
				className="absolute lg:-bottom-18 2xl:-bottom-36 xl:-bottom-24 md:-bottom-12 lg:-translate-y-[15px] -translate-y-[3px] -bottom-2 left-0 w-full"
