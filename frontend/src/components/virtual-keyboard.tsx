...
export function VirtualKeyboard({ className }: { className?: string }) {
	...
	return (
		<div
			className={cn(
				"flex-1  backdrop-blur-sm rounded-lg flex flex-col gap-1",
				className
			)}
		>
			<FakeInput
			...
			/>
			{showKeyboard && (
				<div ref={keyboardRef} className="flex flex-col w-full gap-0.5">
...
function FakeInput({
	...
	return (
		<div
			...
			className={cn(
				"focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring w-[calc(100vw-0.25rem)] overflow-hidden h-11",
