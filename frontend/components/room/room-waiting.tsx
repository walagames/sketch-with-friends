...
const waitingView = {
	[PlayerRole.HOST]: HostWaitingView,
	[PlayerRole.PLAYER]: PlayerWaitingView,
};
...
function Waiting() {
	...
	const WaitingView = waitingView[role as keyof typeof waitingView];
	return (
		<motion.div
			key="waiting"
		...
		>
			{room.status === RoomStatus.WAITING && <WaitingView />}
