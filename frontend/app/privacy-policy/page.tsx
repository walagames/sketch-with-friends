...
export default function PrivacyPolicyPage() {
	return (
		<>
			...
			<p>
				By accessing or using Sketch with Friends, you agree to this Privacy
				Policy. If you do not agree with any part of this policy, please do not
				use our Service. Your continued use of the Service constitutes your
				acceptance of any updates or changes we make to this policy.
			</p>
